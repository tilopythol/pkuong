...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.print("Nhập Link Web Cần Ddos: ");
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Đang Chuyển Bị Đấm : " + url);
        ...
        System.out.println("Cài lại chữ bởi : Nguyen Thanh Phuong");

        System.out.print("Luồng: ");
        ...
        System.out.println("Bắt Đầu Địt Vào Mồm Web");
